var tata = function (t) {
    ...
    function u(t, n, r) {
        ...
        if (!!r.onClick && "function" == typeof r.onClick && b.addEventListener("click", c.bind(m), {
                capture: !0,
                once: !0
    ...
    Object.defineProperty(n, "__esModule", {
            value: !0
        }), n.text = d, n.log = p, n.info = m, n.warn = h, n.error = g, n.success = v, n.ask = b, n.clear = x, r(2),
        function (t) {
            var n = document.createElement("link");
            n.rel = "stylesheet", n.href = t, document.head.appendChild(n)
        }("https://fonts.googleapis.com/icon?family=Material+Icons"), document.addEventListener("click", l, !1);
    var y = [],
        w = {
            type: "log",
            position: "tr",
    ...
    function o(t, n) {
        for (var r = [], e = {}, o = 0; o < t.length; o++) {
            ...
            e[i] ? e[i].parts.push(f) : r.push(e[i] = {
                id: i,
                parts: [f]
            })
        }
    ...
    function f(t, n) {
        ...
        } else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (r = c(n), e = p.bind(null, r, n), o = function () {
            i(r), r.href && URL.revokeObjectURL(r.href)
        }) : (r = s(n), e = d.bind(null, r), o = function () {
            i(r)
        });
        return e(t),
            function (n) {
