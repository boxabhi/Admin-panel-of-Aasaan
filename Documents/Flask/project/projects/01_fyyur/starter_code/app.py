...
def venues():
  ...
  for result in results:
    print(result.city)
    datas = Venue.query.filter_by(city = result.city)
    print(datas)
...
def create_venue_submission():
  ...
  try:
    ...
    venue = Venue(name = data['name'] , city=data['city'], state= data['state'],
                ...
                image_link=data['image_link'], facebook_link=data['facebook_link'])
    ...
    if error:
      flash('Something went wrong!'+request.form['name']+ ' wasnt added to')
    else:
